...
```json
{
  ...
  "id" : "hl7.fhir.nordic.careplans",
  "url" : "http://nordic.hl7.org/fhir/ig/hl7.fhir.nordic.careplans/ImplementationGuide/hl7.fhir.nordic.careplans",
  "version" : "0.1.0",
  ...
  "contact" : [
    {
      ...
      "telecom" : [
        {
          "system" : "url",
          "value" : "http://nordic.hl7.org"
        }
      ]
    }
  ],
  "packageId" : "hl7.fhir.nordic.careplans",
  "license" : "Apache-2.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [
    {
    ...
    "extension" : [
      ...
      },
      {
        "extension" : [
          ...
          {
            "url" : "value",
            "valueString" : "http://nordic.hl7.org/fhir/ig/hl7.fhir.nordic.careplans/history.html"
          }
        ],
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
      },
